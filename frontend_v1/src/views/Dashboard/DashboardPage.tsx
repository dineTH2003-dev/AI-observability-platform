import { Server, Box, Activity, AlertTriangle, TrendingUp, Home, DollarSign, Clock, CheckCircle, XCircle, AlertCircle, Users, Lightbulb, Wrench, TrendingDown } from 'lucide-react';
...
export function DashboardPage({ onNavigate }: DashboardPageProps) {
  ...
  const recentActivity = [
    { time: '2 min ago', event: 'Incident INC-342 created', type: 'incident', severity: 'critical' },
    { time: '15 min ago', event: 'Alex acknowledged INC-341', type: 'action', severity: 'info' },
    { time: '30 min ago', event: 'New anomaly detected on prod-db-01', type: 'anomaly', severity: 'warning' },
    { time: '45 min ago', event: 'Sarah resolved INC-340', type: 'resolved', severity: 'success' },
    { time: '1h ago', event: 'Alert sent: Memory spike on API Gateway', type: 'alert', severity: 'warning' },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-nebula-navy-light border-nebula-navy-lighter hover:border-nebula-purple/50 transition-colors cursor-pointer">
          <CardContent className="p-6">
            ...
            <div className="flex items-center gap-1 text-xs">
              <span className="text-green-400">242 healthy</span>
              <span className="text-slate-500">•</span>
              <span className="text-yellow-400">6 degraded</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-nebula-navy-light border-nebula-navy-lighter hover:border-nebula-blue/50 transition-colors cursor-pointer">
          <CardContent className="p-6">
            ...
            <div className="flex items-center gap-1 text-xs">
              <span className="text-green-400">38 running</span>
              <span className="text-slate-500">•</span>
              <span className="text-red-400">4 issues</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-nebula-navy-light border-nebula-navy-lighter hover:border-nebula-cyan/50 transition-colors cursor-pointer">
          <CardContent className="p-6">
            ...
            <div className="flex items-center gap-1 text-xs">
              <span className="text-green-400">148 stable</span>
              <span className="text-slate-500">•</span>
              <span className="text-yellow-400">8 degraded</span>
            </div>
          </CardContent>
        </Card>
        ...
        >
          <CardContent className="p-6">
            ...
            <div className="flex items-center gap-1 text-xs">
              ...
              <span className="text-slate-500">since yesterday</span>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="bg-nebula-navy-light border-nebula-navy-lighter">
            <CardContent className="p-6">
              ...
              {/* Incident Summary */}
              <div className="grid grid-cols-5 gap-3 mt-4 pt-4 border-t border-nebula-navy-lighter">
                <div className="text-center">
                  <p className="text-2xl font-bold text-white">{incidentStats.total}</p>
                  <p className="text-xs text-slate-400 mt-1">Total</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold text-slate-400">{incidentStats.unassigned}</p>
                  <p className="text-xs text-slate-400 mt-1">Unassigned</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold text-red-400">{incidentStats.critical}</p>
                  <p className="text-xs text-slate-400 mt-1">Critical</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold text-orange-400">{incidentStats.high}</p>
                  <p className="text-xs text-slate-400 mt-1">High</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold text-purple-400">{incidentStats.acknowledged}</p>
