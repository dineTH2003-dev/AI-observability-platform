      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out " +
            ...
            "fixed inset-0 z-50 grid w-full max-w-[calc(100%-2rem)] " +
            "h-fit max-h-[90vh] overflow-y-auto m-auto gap-4 rounded-lg border p-6 shadow-lg duration-200 sm:max-w-lg",
          className
        )}
        {...props}
      >
