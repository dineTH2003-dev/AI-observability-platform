...
export function AnomaliesPage({ selectedAnomalyId }: AnomaliesPageProps) {
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <div className="flex flex-col items-center">
                        <div className={`w-3 h-3 rounded-full ${
                          anomaly.status === 'detected' || anomaly.status === 'assigned' || anomaly.status === 'acknowledged' || anomaly.status === 'resolved'
                            ? 'bg-green-500'
                            : 'bg-slate-500'
                        }`}></div>
                      ...
                      <div className={`h-0.5 flex-1 mx-1 ${
                        anomaly.assignedTime ? 'bg-green-500' : 'bg-slate-600'
                      }`}></div>

                      {/* Assigned */}
                      <div className="flex flex-col items-center">
                        <div className={`w-3 h-3 rounded-full ${
                          anomaly.assignedTime
                            ? 'bg-green-500'
                            : 'bg-slate-500'
                        }`}></div>
                      ...
                      {/* Line */}
                      <div className={`h-0.5 flex-1 mx-1 ${
                        anomaly.acknowledgedTime ? 'bg-green-500' : 'bg-slate-600'
                      }`}></div>

                      {/* Acknowledged */}
                      <div className="flex flex-col items-center">
                        <div className={`w-3 h-3 rounded-full ${
                          anomaly.acknowledgedTime
                            ? 'bg-green-500'
                            : 'bg-slate-500'
                        }`}></div>
                      ...
                      {/* Line */}
                      <div className={`h-0.5 flex-1 mx-1 ${
                        anomaly.resolvedTime ? 'bg-green-500' : 'bg-slate-600'
                      }`}></div>

                      {/* Resolved */}
                      <div className="flex flex-col items-center">
                        <div className={`w-3 h-3 rounded-full ${
                          anomaly.resolvedTime
                            ? 'bg-green-500'
                            : 'bg-slate-500'
                        }`}></div>
